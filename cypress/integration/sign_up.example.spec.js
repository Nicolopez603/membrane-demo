...
describe('Test suite at sign-up',function(){
    ...
    it('Validating text of fields and elements importants',function(){
        ...
        signUpPage.elements.membraneTitle()
        .should('contain.text','Membrane')

        signUpPage.elements.membraneLogo()
        .should('be.visible')

        signUpPage.elements.signUpTitle()
        .should('have.text', ' Sign Up')
    
        signUpPage.elements.informativeText()
        .should('have.text', ' Please, enter your personal information')

        signUpPage.elements.requiredFieldText()
        .should('have.text','*Required fields')

        signUpPage.elements.firstNameInput()
        .should('have.attr', 'placeholder', 'Enter your first name here')
        
        signUpPage.elements.lastNameInput()
        .should('have.attr', 'placeholder', 'Enter your last name here')
        
        signUpPage.elements.emailInput()
        .should('have.attr', 'placeholder', 'Enter your email here')
        
        signUpPage.elements.countryInput()
        .should('have.attr', 'placeholder', 'Country code')
        
        signUpPage.elements.numberInput()
        .should('have.attr', 'placeholder', 'Enter your mobile number')

        signUpPage.elements.alreadyAccountButton()
        .should('be.visible')
    });

    it('Validating button "Next" is Disabled',function(){
        signUpPage.elements.buttonNextDisabled()
        .should('be.disabled')  
    });
    ...
    it('Validating message error "This field is required"',function(){
        ...
        signUpPage.elements.bottomOfForm()
        .click()

        signUpPage.elements.alertLastNameEmptyField()
        .should('have.text','This field is required')
        
        signUpPage.elements.alertNameEmptyField()
        .should('have.text','This field is required')
        
        signUpPage.elements.alertEmailEmptyField()
        .should('have.text','This field is required')
        
        signUpPage.elements.alertNumberEmptyField()
        .should('have.text','This field is required')
    });
    ...
    it('Validating the message error "Invalid email format"',function(){
        ...
        signUpPage.typeEmail(this.credentials.emailInvalid)}).then(()=>{
        
        signUpPage.elements.alertInvalidEmail()
    ...
    it('Validating all the fields with real data and the button "Next" is active',function(){
        ...
        signUpPage.elements.selectableList()
        .click()
       
        signUpPage.typeNumber(this.credentials.phoneNumber)

        cy.readFile('cypress/fixtures/userCredentials.json').then(credentials =>{
        signUpPage.typeEmail(this.credentials.emailValid)}).then(()=>{
        
        signUpPage.elements.buttonNextActivate()
